...
directories=(massari hijab sapience blogging_theology)
titles=("Video summaries generated by AI technology, plus Natural Language Processing (NLP) machine learning transcripts, of Prof. Dr. Muhammad Al-Massari" "Video summaries generated by AI technology, plus Natural Language Processing (NLP) machine learning transcripts, of Mohammed Hijab" "Video summaries generated by AI technology, plus Natural Language Processing (NLP) machine learning transcripts, of Hamza Tzortzis and other eminent speakers" "Video summaries generated by AI technology, plus Natural Language Processing (NLP) machine learning transcripts, of Paul Williams and interviews by him")
